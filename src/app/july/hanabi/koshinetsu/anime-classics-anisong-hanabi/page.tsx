...
export const metadata: Metadata = {
  ...
  description: '7月5日山梨县富士川町举办的动漫经典动画歌曲花火大会。1万发花火与怀念动漫音乐完美同步，井上あずみ现场演出，打造跨世代感动体验。',
  keywords: '动漫花火,富士川町,动画歌曲,山梨花火大会,7月花火,井上あずみ,アニメクラシックス',
  openGraph: {
    title: '动漫经典动画歌曲花火 2025 | 山梨富士川町花火大会',
    description: '7月5日，1万发花火与怀念动漫音乐的完美融合。井上あずみ现场演出，制作会社跨界合作。',
