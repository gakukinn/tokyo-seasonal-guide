      ...
      <nav className="relative z-10 bg-blue-300 border-b border-blue-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <span className="text-gray-900 font-medium">八月 · 葉月</span>
          </div>
        </div>
      </nav>
      ...
      <main className="relative z-10">
            ...
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-2">
                  八月 <span className="text-blue-400">葉月</span>
                </h1>
        ...
        <section className="py-12 bg-gradient-to-r from-white/90 via-pink-50/80 to-blue-50/80 backdrop-blur-sm border-t border-blue-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-gray-800 text-center mb-4">八月活动分类</h2>
            <p className="text-gray-600 text-center mb-12">
              选择感兴趣的活动类型，探索八月的精彩内容
            </p>
        ...
        <section className="py-16 bg-gradient-to-br from-pink-50/90 via-white/85 to-blue-50/90 backdrop-blur-sm border-t border-red-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold text-gray-800 text-center mb-12">八月旅游实用信息</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 hover:shadow-lg transition-all">
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  <div className="flex justify-between">
                    <span>平均气温：</span>
                    <span className="text-gray-800 font-medium">28-35°C</span>
                  </div>
                  <div className="flex justify-between">
                    <span>湿度：</span>
                    <span className="text-gray-800 font-medium">80-90%</span>
                  </div>
                  <div className="flex justify-between">
                    <span>降雨：</span>
                    <span className="text-gray-800 font-medium">偶有雷阵雨</span>
                  </div>
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 hover:shadow-lg transition-all">
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  ...
                  <div className="flex justify-between">
                    <span>花火大会：</span>
                    <span className="text-gray-800 font-medium">专门加班</span>
                  </div>
                  <div className="mt-4 p-3 bg-blue-100 border border-blue-300 rounded-lg">
                    <p className="text-blue-700 text-xs">
                      💡 花火大会日请提前规划返程路线
              ...
              <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-6 hover:shadow-lg transition-all">
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  <div className="flex justify-between">
                    <span>住宿预订：</span>
                    <span className="text-gray-800 font-medium">需提前2-3周</span>
                  </div>
                  <div className="flex justify-between">
                    <span>热门活动：</span>
                    <span className="text-gray-800 font-medium">一票难求</span>
                  </div>
                  <div className="flex justify-between">
                    <span>营业时间：</span>
