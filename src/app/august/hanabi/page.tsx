...
const regions = [
  { id: 'tokyo', name: '东京', count: 6, available: true },
  { id: 'around', name: '周边', count: 1, available: true },
  { id: 'kanagawa', name: '神奈川', count: 13, available: true },
  { id: 'saitama', name: '埼玉', count: 2, available: true },
      ...
      <nav className="relative z-10 bg-blue-300 border-b border-blue-400">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center space-x-2 text-sm">
            ...
            <Link href="/august" className="text-gray-700 hover:text-gray-900 transition-colors">
              八月 · 葉月
            </Link>
            <span className="text-gray-600">›</span>
        ...
        <section className="pt-16 pb-12 text-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center space-x-4 mb-6">
              ...
              <div>
                <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-2">
                  八月 <span className="text-blue-400">花火大会</span>
                </h1>
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              八月是关东地区花火大会的最盛月份，包含了江户川、葛饰、足立等顶级花火大会
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-8">
              {regions.slice(0, 2).map((region) => (
                <Link
                  key={region.id}
                  href={region.available ? `/august/hanabi/${region.id}` : '#'}
